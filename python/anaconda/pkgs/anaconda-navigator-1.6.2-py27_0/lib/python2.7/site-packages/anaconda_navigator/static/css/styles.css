...
FrameTabHeader#documentation,
FrameContentHeader#documentation {
  background: #007041; }

FrameTabHeader#training,
FrameContentHeader#training {
  background: #615E9B; }

FrameTabHeader#video,
FrameContentHeader#video {
  background: #006298; }

FrameTabHeader#webinar,
FrameContentHeader#webinar {
  background: #F3D03E; }

FrameTabHeader#event,
FrameContentHeader#event {
  background: #006298; }

FrameTabHeader#forum,
FrameContentHeader#forum {
  background: #615E9B; }

FrameTabHeader#social,
FrameContentHeader#social {
  background: #007041; }
